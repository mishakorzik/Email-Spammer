...
def sys_check():
	...
	sys_url = 'https://raw.githubusercontent.com/mishakorzik/Email-Spammer/main/.start'
	try:
...
try:
	...
	print('10. XxEmailSpammer@gmail.com')
	print(bcolors.WARNING + 'example: smtp0python@gmail.com' + bcolors.ENDC)
	user = input(bcolors.WARNING + 'Select email: ' + bcolors.ENDC)
	if user == 'address1@domain.com':
		pwd = 'password123'
	elif user == 'address2@domain.com':
		pwd = 'password456'
	elif user == 'XxEmailSpammer@gmail.com':
		pwd = '7^@mWx@dq8'
	elif user == 'smtp3python@gmail.com' or user == 'smtp4python@gmail.com' or user == 'smtp6python@gmail.com' or user == 'smtp7python@gmail.com':
